...
describe('ConverterService', () => {
  ...
  it('should convert a searchable tree into a treetable tree', () => {
    ...
    expect(instanceOfSearchableNode(service.toTreeTableTree(mockSearchableTree, false))).toBe(true);
  });
  ...
  it('should clone the trees', () => {
    ...
    expect(mockTreeTableTree !== service.toTreeTableTree(mockTreeTableTree, false)).toBe(true);
    expect(_.isEqual(mockTreeTableTree, service.toTreeTableTree(mockTreeTableTree, false))).toBe(true);
  });
